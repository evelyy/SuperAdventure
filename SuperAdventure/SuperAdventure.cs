...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        private void MonsterAttack(Monster _currentMonster, Player _player)
        {
            // monster's turn to attack

            // find monster dmg, apply to player
            int damageToPlayer = RandomNumberGenerator.NumberBetween(0, _currentMonster.MaxDamage);

            // display msg
            rtbMessages.Text += "The " + _currentMonster.Name + " hits for " + damageToPlayer + " damage!" + Environment.NewLine;
            ...
            public void MoveTo(Location newLocation)
        {
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            _player.ExperiencePoints += newLocation.QuestAvailableHere.RewardXP;
            ...
            if (newLocation.MonsterLivingHere != null)
            {
                ...
                _currentMonster = new Monster(standardMonster.ID, standardMonster.Name, standardMonster.MaxDamage,
                    standardMonster.RewardXP, standardMonster.RewardGold, standardMonster.CurrentHitPoints, standardMonster.MaxHitPoints);
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            // find amnt dmg to monster
            int damageToMonster = RandomNumberGenerator.NumberBetween(currentWeapon.MinDamage, currentWeapon.MaxDamage);

            // apply dam to monster
            _currentMonster.CurrentHitPoints -= damageToMonster;

            // display msg
            rtbMessages.Text += "Hit " + _currentMonster.Name + " for " + damageToMonster.ToString() + " damage!" + Environment.NewLine;
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                // give player xp
                _player.ExperiencePoints += _currentMonster.RewardXP;
                rtbMessages.Text += "You receive " + _currentMonster.RewardXP.ToString() + " XP." + Environment.NewLine;
                ...
                // if no items were rolled, then give the default
                ...
                foreach (InventoryItem ii in lootedItems)
                {
                    ...
                    if (ii.Quantity == 1)
                    {
                        rtbMessages.Text += "You loot 1 " + ii.Details.Name + Environment.NewLine;
                    }
                    else
                    {
                ...
                // refresh player info and inv controls
                lblHitPoints.Text = _player.CurrentHitPoints.ToString();
                lblGold.Text = _player.Gold.ToString();
                lblExperience.Text = _player.ExperiencePoints.ToString();
                lblLevel.Text = _player.Level.ToString();
